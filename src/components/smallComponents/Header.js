                ...
                <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"
                    ...
                    <Navbar bg="dark" variant="dark">
                        ...
                        <Nav>
                            ...
                            <NavDropdown eventKey={5} title="Administrer nettsiden" id="basic-nav-dropdown">
                                ...
                                <MenuItem href="/admin/center" eventKey={5.4}>Oversikt over behandlingssteder</MenuItem>
                            </NavDropdown>
                        </Nav>
                </Navbar>
